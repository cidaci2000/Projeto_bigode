...
body
{
	...
	background-image: url(banner/banner\ academia.jpg);
	background-size: 95%;
...
.card .details a 
{
	...
	color: #4ba9e9;
			...
			<div class="card">
				<div class="imgBx">
					<img src="Academia/creatina/Creatina1.jpeg">
				</div>
				<div class="details">
			...
			<div class="card">
				<div class="imgBx">
					<img src="Academia/Whey/Whey1.jpeg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="Academia/BCAA/BCAA.jpeg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="Academia/Maltodextrina/Maltodextrina.jpeg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
