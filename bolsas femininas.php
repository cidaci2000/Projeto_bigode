...
body
{
	...
	background-image: url(banner/banner17.jpg);
    background-size: 95%;
...
.card .details a 
{
	...
	color: #4ba9e9;
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa2.jpg">
				</div>
				<div class="details">
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa feminina.jpg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa3.jpg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa4.jpg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa5.jpg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa6.jpg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa7.jpg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa8.jpg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa9.jpg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa10.jpg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
			...
			<div class="card">
				<div class="imgBx">
					<img src="bolsa feminino/bolsa11.jpg">
				</div>
				<div class="details">
					<h3>Nike moletom inverno<br><span>Masculino</span></h3>
					<h4>Detalhes do produto</h4>
